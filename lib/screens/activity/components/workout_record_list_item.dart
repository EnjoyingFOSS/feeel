...
class WorkoutRecordListItem extends StatelessWidget {
  ...
  const WorkoutRecordListItem(this.workoutRecord, this.colorSwatch, {Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Material(
        ...
        child: InkWell(
            onTap: () => WorkoutRecordSheet.showSheet(
                context, workoutRecord, colorSwatch),
            child: WorkoutRecordRow(workoutRecord, colorSwatch)));
  }
}
